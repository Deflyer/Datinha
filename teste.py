...
# Verificar a versão do Chrome instalado
...
for competition in competition_list:
    print(f'Título: {competition["title"]}')
    print(f'Prêmio: {competition["prize"]}')
    print(f'Organizadores: {competition["organizers"]}')
    print(f'Link: {competition["link"]}')
    print(f'Categoria: {competition["category"]}')
    print(f'Prazo: {competition["deadline"]} dias.')
    print('-' * 40)
...
def create_competition_print_all(c, n_comp, total_comp):
    '''
    Formats a string with the competition information. Used to get a more beautiful Telegram message.
    '''
...
def button(update: Update, context: CallbackContext):
    '''
    Navigate trhough the competitions with emotes buttons
    '''
    global current_page
